document.addEventListener("DOMContentLoaded", function () {
  ...
  if (sentenceParam && wordsParam) {
    // If parameters are present, show only the animation
    console.log('show animation');
    document.getElementById("generator").style.display = "none";
    document.getElementById("animation").style.display = "block";

    loadPreviewFromURL(window.location.href);
  } else {
  ...
  function updatePreview() {
    ...
    console.log("sentence: " + sentenceInput); // Should log the sentence input element or null/undefined if not found.
    console.log("words: " + wordsInputs.length); // Should log the NodeList of word inputs.
    console.log("colors: " + colorsInputs.length); // Should log the NodeList of color inputs.
  ...
  function loadPreviewFromURL(url) {
    console.log("attempting to load preview with url: ", url);
